        ...
        if (e.keyCode != 13 && e.keyCode != 40 && e.keyCode != 38) { // not Enter,Up,Down arrow
            ...
            for (i = 0; i < arr.length; i++) {
                ...
                if (arr[i].name.substr(0, val.length).toUpperCase() == val.toUpperCase()) {
                    ...
                    b.innerHTML += arr[i].company.substr(val.length);
...
function addFooter() {
    ...
    <div class="copy-right">
        <p><a href="index.html"</a>Luyện thi đại học Ước Mơ - All rights reserved © 2020 - Designed by
            <span style="color: #eee; font-weight: bold">Ước Mơ</span></p>
    </div>`);
}
